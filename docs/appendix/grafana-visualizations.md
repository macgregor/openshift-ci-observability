...
- Name panels as questions or plain-language descriptions ("Build Success Rate" not "ci_build_result ratio")
...
**Template variables** replace separate dashboards. One dashboard with a `$job_type` variable is better than N dashboards per job type.
